...
public class UserMerchantUploadProductImage {
    private String image;
    private String imageKey;
    private String stringBrandname,stringProductKey, stringProductDescription, stringProductName, stringProductPrice, stringGender, stringProductCategory,phoneKey;

    public UserMerchantUploadProductImage() {

    }
    public UserMerchantUploadProductImage(String image,String stringBrandname,String stringProductDescription,String stringProductName,String stringProductPrice,String stringGender,String stringProductCategory,String phoneKey,String stringProductKey) {
        this.image = image;
